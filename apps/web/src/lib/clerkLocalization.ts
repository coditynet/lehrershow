...
export const deDE: LocalizationResource = {
  ...
  apiKeys: {
    ...
    formHint:
      "Geben Sie einen Namen an, um einen API-Key zu erstellen. Sie können ihn jederzeit widerrufen.",
  ...
  commerce: {
    ...
    checkout: {
      ...
      emailForm: {
        subtitle:
          "Geben Sie eine E-Mail-Adresse an, um Abrechnungsbelege zu erhalten.",
    ...
    credit: undefined,
    creditRemainder:
      "Verbleibendes Guthaben für den restlichen Abrechnungszeitraum.",
  ...
  dates: {
    ...
    next6Days:
      "{{ date | weekday('de-DE','long') }} bei {{ date | timeString('de-DE') }}",
    nextDay: "Morgen um {{ date | timeString('de-DE') }}",
    numeric: "{{ date | numeric('de-DE') }}",
    previous6Days:
      "Letzte {{ date | weekday('de-DE','long') }} um {{ date | timeString('de-DE') }}",
  ...
  formFieldInputPlaceholder__organizationDomain:
    "Organisations-Domain eingeben",
  formFieldInputPlaceholder__organizationDomainEmailAddress:
    "E-Mail-Adresse der Organisations-Domain eingeben",
  ...
  formFieldLabel__automaticInvitations:
    "Aktivieren Sie automatische Einladungen für diese Domain",
  ...
  formFieldLabel__organizationDomainDeletePending:
    "Ausstehende Einladungen und Vorschläge löschen",
  ...
  organizationProfile: {
    ...
    profilePage: {
      dangerSection: {
        deleteOrganization: {
          actionDescription:
            'Geben Sie "{{organizationName}}" unten ein, um fortzufahren.',
          messageLine1:
            "Sind Sie sicher, dass Sie diese Organisation löschen wollen?",
    ...
    removeDomainPage: {
      ...
      messageLine2:
        "Benutzer können der Organisation danach nicht mehr automatisch beitreten.",
    ...
    verifiedDomainPage: {
      dangerTab: {
        calloutInfoLabel:
          "Das Entfernen dieser Domain betrifft die eingeladenen Benutzer.",
        removeDomainActionLabel__remove: "Domain entfernen",
        removeDomainSubtitle:
          "Sie können diese Domain von den verifizierten Domains entfernen",
      ...
      enrollmentTab: {
        ...
        calloutInfoLabel:
          "Änderungen des Anmeldemodus wirkt sich nur auf neue Benutzer aus.",
        calloutInvitationCountLabel:
          "Ausstehende Einladungen gesendet an Benutzer: {{count}}",
        calloutSuggestionCountLabel:
          "Ausstehende Vorschläge gesendet an Benutzer: {{count}}",
        manualInvitationOption__description:
          "Benutzer können nur manuell in die Organisation eingeladen werden.",
        manualInvitationOption__label: "Keine automatische Aufnahme",
        subtitle:
          "Wählen Sie, wie Benutzer mit dieser Domain der Organisation beitreten können.",
      },
      start: {
      ...
      subtitle:
        "Die Domain {{domain}} ist nun verifiziert. Bitte wählen Sie einen Aufnahmemodus aus.",
  ...
  reverification: {
    ...
    backupCodeMfa: {
      subtitle:
        "Verwenden Sie den Backup-Code, der Ihnen bei der Registrierung zur Verfügung gestellt wurde.",
      title: "Backup-Code Verifizierung",
    },
    emailCode: {
      formTitle:
        "Geben Sie den Code ein, den wir an Ihre E-Mail-Adresse gesendet haben.",
    ...
    phoneCode: {
      formTitle:
        "Geben Sie den Code ein, den wir an Ihre Telefonnummer gesendet haben.",
      resendButton: "Code erneut senden",
    ...
    phoneCodeMfa: {
      formTitle:
        "Geben Sie den Code ein, den wir Ihnen per SMS gesendet haben.",
      resendButton: "Code erneut senden",
    ...
    totpMfa: {
      ...
      subtitle:
        "Verwenden Sie die Authentifikator-App, die Sie eingerichtet haben.",
  ...
  signIn: {
    ...
    alternativeMethods: {
      ...
      subtitle:
        "Haben Sie Probleme? Sie können eine der folgenden Methoden zur Anmeldung verwenden.",
    ...
    emailLink: {
      ...
      formSubtitle:
        "Verwenden Sie den an Ihre E-Mail gesendeten Bestätigungslink",
      ...
      verifiedSwitchTab: {
        ...
        subtitleNewTab:
          "Kehren Sie zum neu geöffneten Tab zurück, um fortzufahren",
    ...
    forgotPassword: {
      ...
      subtitle_email:
        "Geben Sie zunächst den an Ihre E-Mail gesendeten Code ein",
      subtitle_phone:
        "Geben Sie zunächst den auf Ihr Mobiltelefon geschickten Code ein",
      title: "Passwort zurücksetzen",
    },
    forgotPasswordAlternativeMethods: {
      blockButton__resetPassword: "Passwort zurücksetzen",
      label__alternativeMethods:
        "Oder melden Sie sich mit einer anderen Methode an",
      title: "Passwort vergessen?",
    },
    noAvailableMethods: {
      message:
        "Die Anmeldung kann nicht fortgesetzt werden. Es ist kein Authentifizierungsfaktor verfügbar.",
    ...
    phoneCodeMfa: {
      ...
      resendButton: "Code erneut senden",
      subtitle:
        "Um fortzufahren, geben Sie bitte den Bestätigungscode ein, der an Ihre Telefonnummer gesendet wurde",
      title: "Schau auf dein Telefon",
    },
    resetPassword: {
      ...
      successMessage:
        "Ihr Passwort wurde erfolgreich geändert. Bitte warten Sie einen Moment, um Sie anzumelden.",
      title: "Neues Passwort setzen",
    },
    resetPasswordMfa: {
      detailsLabel:
        "Bevor wir Ihr Passwort zurücksetzen können, müssen wir Ihre Identität überprüfen.",
    },
    start: {
      actionLink: "Anmelden",
      ...
      alternativePhoneCodeProvider: {
        ...
        subtitle:
          "Geben Sie Ihre Telefonnummer ein, um einen Bestätigungscode per {{provider}} zu erhalten.",
        title: "In {{applicationName}} mit {{provider}} einloggen",
      },
      subtitle: "Melden Sie sich an, um fortzufahren",
      subtitleCombined: undefined,
      title: "Anmelden",
      titleCombined: "Anmelden",
    },
    totpMfa: {
      formTitle: "Bestätigungscode",
      subtitle:
  ...
  signUp: {
    alternativePhoneCodeProvider: {
      resendButton: "Bestätigungscode nicht erhalten? Erneut senden",
      subtitle:
        "Geben Sie den Bestätigungscode ein, der an {{provider}} gesendet wurde",
    ...
    emailLink: {
      clientMismatch: {
        subtitle:
          "Die Anfrage konnte nicht verarbeitet werden, da der Client nicht kompatibel ist.",
        title: "Fehler: Inkompatibler Client",
      },
      formSubtitle:
        "Verwenden Sie den an Ihre E-Mail-Adresse gesendeten Bestätigungslink",
      formTitle: "Bestätigungslink",
      loading: {
        title: "Anmeldung...",
      },
    ...
    legalConsent: {
      checkbox: {
        label__onlyPrivacyPolicy:
          'Ich stimme der {{ privacyPolicyLink || link("Datenschutzerklärung") }} zu',
        label__onlyTermsOfService:
          'Ich stimme den {{ termsOfServiceLink || link("Nutzungsbedingungen") }} zu',
        label__termsOfServiceAndPrivacyPolicy:
          'Ich stimme den {{ termsOfServiceLink || link("Nutzungsbedingungen") }} und der {{ privacyPolicyLink || link("Datenschutzerklärung") }} zu',
      },
      continue: {
        subtitle:
          "Bitte lesen und akzeptieren Sie die Bedingungen, um fortzufahren",
    ...
    restrictedAccess: {
      ...
      subtitle:
        "Ihr Zugang ist momentan eingeschränkt. Wenn sie ein Konto haben, melden sie sich bitte an.",
      subtitleWaitlist:
        "Treten Sie der Warteliste bei, um Benachrichtigungen zu erhalten.",
  ...
  unstable__errors: {
    already_a_member_in_organization:
      "Sie sind bereits Mitglied in dieser Organisation.",
    captcha_invalid:
    ...
    form_code_incorrect:
      "Der eingegebene Code ist falsch. Bitte überprüfen Sie ihn und versuchen Sie es erneut.",
    form_identifier_exists__email_address:
      "Diese E-Mail-Adresse ist bereits vergeben. Bitte wählen Sie eine andere.",
    form_identifier_exists__phone_number:
      "Diese Telefonnummer ist bereits vergeben. Bitte wählen Sie eine andere.",
    form_identifier_exists__username:
      "Dieser Benutzername ist bereits vergeben. Bitte wählen Sie einen anderen.",
    form_identifier_not_found:
      "Wir konnten kein Konto mit diesen Details finden.",
    form_param_format_invalid:
      "Das Format des eingegebenen Parameters ist ungültig.",
    form_param_format_invalid__email_address:
      "Bitte geben Sie eine gültige E-Mail-Adresse ein.",
    form_param_format_invalid__phone_number:
      "Die Telefonnummer muss ein gültiges internationales Format haben.",
    form_param_max_length_exceeded__first_name:
      "Der Vorname sollte nicht mehr als 256 Zeichen umfassen.",
    form_param_max_length_exceeded__last_name:
      "Der Nachname sollte nicht mehr als 256 Zeichen umfassen.",
    form_param_max_length_exceeded__name:
      "Der Name sollte nicht länger als 256 Zeichen sein.",
    form_param_nil:
      "Ein erforderliches Feld wurde nicht ausgefüllt. Bitte überprüfen Sie Ihre Eingaben.",
    ...
    identification_deletion_failed:
      "Sie können Ihre letzte Kennung nicht löschen.",
    not_allowed_access:
    ...
    organization_domain_blocked:
      "Diese E-Mail-Provider-Domain ist gesperrt. Bitte verwenden Sie eine andere.",
    organization_domain_common:
      "Dies ist eine gängige E-Mail-Provider-Domain. Bitte verwenden Sie eine andere.",
    ...
    passkey_already_exists:
      "Auf diesem Gerät ist bereits ein Passkey registriert.",
    ...
    zxcvbn: {
      couldBeStronger:
        "Ihr Passwort funktioniert, könnte aber besser sein. Versuchen Sie, mehr Zeichen hinzuzufügen.",
      ...
      suggestions: {
        ...
        pwned:
          "Wenn Sie dieses Passwort an anderer Stelle verwenden, sollten Sie es ändern.",
      ...
      warnings: {
        ...
        pwned:
          "Ihr Passwort wurde durch eine Datenpanne im Internet offengelegt.",
  ...
  userProfile: {
    ...
    backupCodePage: {
      ...
      subtitle__codelist:
        "Bewahren Sie die Codes sicher auf und halten Sie sie geheim.",
      successMessage:
    ...
    emailAddressPage: {
      emailCode: {
        formHint:
          "An diese E-Mail-Adresse wird eine E-Mail mit einem Bestätigungscode gesendet.",
        formSubtitle:
          "Geben Sie den Bestätigungscode ein, der an {{identifier}} gesendet wird",
        formTitle: "Verifizierungs-Schlüssel",
        resendButton: "Code erneut senden",
        successMessage:
          "Die E-Mail-Adresse {{identifier}} wurde Ihrem Konto hinzugefügt.",
      },
      emailLink: {
        formHint:
          "An diese E-Mail-Adresse wird eine E-Mail mit einem Bestätigungslink gesendet.",
        formSubtitle:
          "Klicken Sie auf den Bestätigungslink in der an {{identifier}} gesendeten E-Mail",
        formTitle: "Bestätigungslink",
        resendButton: "Link erneut senden",
        successMessage:
          "Die E-Mail-Adresse {{identifier}} wurde Ihrem Konto hinzugefügt.",
      ...
      formHint:
        "Sie müssen diese E-Mail-Adresse verifizieren, bevor sie Ihrem Konto hinzugefügt werden kann.",
      removeResource: {
        messageLine1: "{{identifier}} wird aus diesem Konto entfernt.",
        messageLine2:
          "Sie können sich nicht mehr mit dieser E-Mail-Adresse anmelden.",
    ...
    mfaPhoneCodePage: {
      ...
      removeResource: {
        messageLine1:
          "{{identifier}} erhält bei der Anmeldung keine Bestätigungscodes mehr.",
        messageLine2:
          "Ihr Konto ist möglicherweise nicht so sicher. Bist du dir sicher, dass du weitermachen willst?",
        successMessage:
          "SMS-Code-Bestätigung in zwei Schritten wurde für {{mfaPhoneCode}} entfernt",
    ...
    mfaTOTPPage: {
      ...
      removeResource: {
        messageLine1:
          "Bei der Anmeldung sind keine Bestätigungscodes von diesem Authentifikator mehr erforderlich.",
        messageLine2:
          "Ihr Konto ist möglicherweise nicht mehr so sicher. Sind Sie sich sicher, dass Sie fortfahren wollen?",
        successMessage:
          "Die zweistufige Verifizierung über die Authentifizierungs-App wurde entfernt.",
        title: "Entfernen Sie die Bestätigung in zwei Schritten",
      },
      successMessage:
      ...
      verifySubtitle:
        "Geben Sie den von Ihrem Authentifikator generierten Bestätigungscode ein",
    ...
    passkeyScreen: {
      ...
      subtitle__rename:
        "Sie können den Namen des Passkeys ändern, um ihn leichter zu finden.",
    ...
    passwordPage: {
      ...
      successMessage__signOutOfOtherSessions:
        "Alle anderen Geräte wurden abgemeldet.",
    ...
    phoneNumberPage: {
      infoText:
        "An diese Telefonnummer wird eine SMS mit einem Bestätigungslink gesendet.",
      removeResource: {
        messageLine1: "{{identifier}} wird aus diesem Konto entfernt.",
        messageLine2:
          "Sie können sich nicht mehr mit dieser Telefonnummer anmelden.",
    ...
    profilePage: {
      fileDropAreaHint:
        "Laden Sie ein JPG-, PNG-, GIF- oder WEBP-Bild hoch, das kleiner als 10 MB ist",
    ...
    start: {
      ...
      connectedAccountsSection: {
        ...
        subtitle__disconnected:
          "Ihr Konto ist derzeit getrennt. Bitte verbinden Sie es erneut.",
    ...
    web3WalletPage: {
      removeResource: {
        messageLine1: "{{identifier}} wird aus diesem Konto entfernt.",
        messageLine2:
          "Sie können sich nicht mehr mit diesem Web3-Wallet anmelden.",
        successMessage: "{{web3Wallet}} wurde aus Ihrem Konto entfernt.",
        title: "Entfernen Sie das Web3-Wallet",
      },
      subtitle__availableWallets:
        "Wählen Sie ein Web3-Wallet aus, um sich mit Ihrem Konto zu verbinden.",
  ...
  waitlist: {
    ...
    success: {
      ...
      subtitle:
        "Vielen Dank für Ihre Geduld. Sie erhalten eine Benachrichtigung, sobald der Zugang freigegeben wird.",
